...
| 6 | `GET /proposals` / `GET /proposals/:id` | Returns only the caller's own Proposals (`404` if it belongs to someone else), including `media[]`, `investorCount`, and `raisedAmount`. |
